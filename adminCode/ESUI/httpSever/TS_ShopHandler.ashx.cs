...
namespace ESUI.httpSever
{
    ...
    public class TS_ShopHandler : IHttpHandler
    {
        ...
        TS_ShopBiz OPBiz = new TS_ShopBiz();
        // 请求例子  /httpSever/TS_ShopHandler.ashx?json={"jsonEntity":{"Category":"05","CityCode":"4502","Longitude":"110.22587","Latitude":"25.272585"},"pageIndex":"1","pageSize":"20","action":"GetByCategory"}
            ...
            try
            {
                ...
                switch (httpObject["action"].ToString())
                {
                    ...
                    case "GetById":
                        ...
                        var mqlG = TS_ShopSet.SelectAll().Where(TS_ShopSet.Id.Equal(Id));
                        TS_Shop modelG = OPBiz.GetEntity(mqlG);
                        if (modelG != null)
                        {
                            resultMode.Code = 11;
                            resultMode.Msg = "获取成功";

...
namespace e3net.Mode.TramStewardDB
{
    ...
    public  partial class v_TS_ServiceSet : MQLBase
    {
        ...
        /// 
        /// </summary>
        public static readonly FieldBase ProvinceName = new FieldBase(DbType.SqlServer, "[v_TS_Service]", FieldType.Common, "[ProvinceName]");

        /// <summary>
        /// 
        /// </summary>
        public static readonly FieldBase CityName = new FieldBase(DbType.SqlServer, "[v_TS_Service]", FieldType.Common, "[CityName]");

        /// <summary>
        /// 
        /// </summary>
        public static readonly FieldBase AreaName = new FieldBase(DbType.SqlServer, "[v_TS_Service]", FieldType.Common, "[AreaName]");

        /// <summary>
        /// 
        /// </summary>
        public static readonly FieldBase TrueName = new FieldBase(DbType.SqlServer, "[v_TS_Service]", FieldType.Common, "[TrueName]");

        /// <summary>
        /// 
        /// </summary>
        public static readonly FieldBase UserName = new FieldBase(DbType.SqlServer, "[v_TS_Service]", FieldType.Common, "[UserName]");

        /// <summary>
        /// 
        /// </summary>
        public static readonly FieldBase geohash = new FieldBase(DbType.SqlServer, "[v_TS_Service]", FieldType.Common, "[geohash]");
    }
